...
-- name to MUCHO GROUCHO, as that is exactly what the actor will be with the 
...
SET first_name = "GROUCHO"
    WHEN actor_id = 172 THEN first_name = "HARPO"
...
-- SELECT * FROM store;
-- SELECT * FROM payment;
SELECT staff_id, SUM(amount) as "total_sum"
FROM payment
...
-- payment --> need sum of amount then limit to 5 in desc order
